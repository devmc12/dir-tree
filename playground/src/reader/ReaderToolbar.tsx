    ...
    <header className={styles.toolbar}>
      ...
      <div className={styles.toolbarActions}>
        <nav
          ...
          aria-label={copy.toolbar.projectLinks}>
          <a
            aria-label={copy.toolbar.openGithub}
            className={`${styles.outlineButton} ${styles.toolbarLink}`}
            href="https://github.com/devmc12/dir-tree"
            rel="noopener noreferrer"
            target="_blank"
            title={copy.toolbar.openGithub}>
            {/* GitHub Mark from https://github.com/primer/octicons/blob/main/icons/mark-github-24.svg */}
            ...
            <span className={styles.toolbarLinkLabel}>GitHub</span>
          </a>
          <a
            aria-label={copy.toolbar.openWebsite}
            className={`${styles.outlineButton} ${styles.toolbarLink}`}
            href="https://dir-tree.com/"
            rel="noopener noreferrer"
            target="_blank"
            title={copy.toolbar.openWebsite}>
            <Globe2 aria-hidden="true" />
            <span className={styles.toolbarLinkLabel}>dir-tree.com</span>
          </a>
        </nav>
